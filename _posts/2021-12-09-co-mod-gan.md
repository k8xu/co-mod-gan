...
![FFHQ Sampled Images]({{ site.url }}/public/images/2021-12-09-co-mod-gan/ffhq_experiment2.png)
...
In image completion tasks for images sampled from the FFHQ dataset, as the mask covered up more of the image, there were noticeable changes in age, race, and gender as well as facial expressions, clothing, and accessories from the generated image to the input image.

ADD FIGURES AND BRIEF ANALYSIS
